            ...
            function get_info(){
                ...
                document.getElementById("room_info").innerHTML = 
						...
						"<div class=\"item-info\"> <label>Total: </label> <span> £" + cost + " </span> </div>" +
                                                "<div class=\"item-info\"> <label>Name</label> <span> <input type=\"text\" name=\"name\" placeholder=\"" + name + "\"></span> </div>" +
                                                "<div class=\"item-info\"> <label>Address</label> <span> <input type=\"text\" name=\"address\" placeholder=\"" + address + "\"></span> </div>" +
                                                "<div class=\"item-info\"> <label>Email</label> <span> <input type=\"text\" name=\"email\" placeholder=\"" + email + "\"></span> </div>" +
                                                "<div class=\"item-info\"> <label>Notes</label> <span> <input type=\"text\" name=\"notes\" placeholder=\"" + notes + "\"></span> </div>" +
                                                "</div>"+
                                                "</p>"
            }
  ...
  <body onload="get_info()">
    <div class="body-wrapper">
		...
		<div class="content-wrapper">
			...
			<p align="center"><button href="index.html">Home</button></p>
			</div>
