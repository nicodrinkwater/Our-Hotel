    ...
    <div class="body-wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="booking-information" >
					...
					<div class="room-info">
						<div class="item-info">	<label>Booking Reference</label> <span> <input type="text" name="b_ref" placeholder="Reference Number" size="20"> </span> </div>
                                             
                                                <p align="center">
                                                  OR:   
                                                </p>
						<div class="item-info">	<label>Name</label> <span> <input type="text" name="name" placeholder="Name" size="20"> </span> </div>
						<div class="item-info">	<label>Check In Date</label> <span> <input type="date" name="check_in" size="20" value="Checkin date"> </span> </div>
					</div>
